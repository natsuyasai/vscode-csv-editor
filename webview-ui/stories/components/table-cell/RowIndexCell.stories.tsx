...
import type { RowIndexCellProps } from "@/components/editable-table/types";
import { RowIndexCell } from "@/components/table-cell/RowIndexCell";

const meta: Meta<typeof RowIndexCell> = {
  title: "components/table-cell/RowIndexCell",
